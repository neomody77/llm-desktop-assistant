...
# Note: Live2dModel import removed for desktop assistant
...
# live2d_model parameter removed for desktop assistant
    ...
    try:
        if isinstance(output, SentenceOutput):
            full_response = await handle_sentence_output(
                output,
# live2d_model,  # removed for desktop assistant
                tts_engine,
                websocket_send,
                tts_manager,
                translate_engine,
...
# live2d_model parameter removed for desktop assistant
    ...
    async for display_text, tts_text, actions in output:
        ...
        await tts_manager.speak(
            ...
            actions=actions,
# live2d_model=live2d_model,  # removed for desktop assistant
